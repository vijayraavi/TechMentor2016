    ...
    AllNodes = @(
       ...
       # Unique Data for each Role
         @{
            ...
            CertThumbPrint = Invoke-Command -Computername 'DC.company.pri' {Get-Childitem Cert:\LocalMachine\My | Where-Object {$_.FriendlyName -like "*wild*"} | Select-Object -ExpandProperty ThumbPrint}
